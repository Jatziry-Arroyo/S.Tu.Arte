...
//document.addEventListener('DOMContentLoaded', function () {
  //  'use strict';
    ...
    artistaInput.addEventListener('input', function () {
        validateRegex(artistaInput, /^[a-zA-Z0-9,.\sáéíóúÁÉÍÓÚñÑüÜ]{5,50}$/, 'Mínimo 5 caracteres (letras y números)');
    });
    ...
    descripcionInput.addEventListener('input', function () {
        validateRegex(descripcionInput, /^[a-zA-Z0-9,.\sáéíóúÁÉÍÓÚñÑüÜ]{10,500}$/, 'Mínimo 30 caracteres (letras y números)');
    });
